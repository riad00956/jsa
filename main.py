...
dashboard_config = {
    ...
    "reply_markup": {
        "keyboard": [
            [{"text": "👤 PROFILE", "style": "primary"}, {"text": "💥 BOOMBER", "style": "danger"}],
...
def cmd_admin(message: types.Message) -> None:
    ...
    bot.send_message(ADMIN_ID,
        "🔧 *『 𝑿𝒀𝑹𝑶𝑵 𝑻𝑭𝑴64 』 Master Control Panel*\n\nSelect an action below:",
        parse_mode="Markdown",
...
@bot.message_handler(func=lambda m: m.text == "💥 BOOMBER")
